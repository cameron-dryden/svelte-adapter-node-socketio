...
export default [
  ...
  },
  {
    ...
    external: ["ENV", "MANIFEST", "SERVER", "SHIMS", "SOCKETIO"],
  },
  {
    input: "src/socketio.js",
    output: {
      file: "files/socketio.js",
      format: "esm",
      inlineDynamicImports: true,
    },
    plugins: [
      clearOutput("files/socketio.js"),
      nodeResolve(),
      commonjs(),
      json(),
      prefixBuiltinModules(),
